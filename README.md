...
- I believe that building awesome things comes from incremental improvements over time. I find myself bothered by proposals for large changes with broad surface areas when there are alternatives to make small, scoped, tactical, changes that can be layered upon each other to reach the same or better outcomes. 
