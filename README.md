...
- I was born in Bosnia. Because of the war in the early 90s I moved to Germany with my mom and my sister when I started elementary school. We moved to Kentucky when I was twelve. I speak English, Bosnian, and German.
...
- Things that I like to do outside of work:
  ...
  * Exercise. Primarily running, walking, hiking, and resistance training.
  * Swim in or hang out by the pool
  * Travel. Warm places with beaches and big cities are my favorite destinations.
  * Play video games. Primarily sports simulations like Pro Evolution Soccer (PES) and FIFA.
...
- ***I'm empathetic.*** I care deeply about my direct reports, other team members, and our users. I frequently try to put myself in other people's shoes.
- ***I'm genuine.*** I'm honest and I speak from my heart.
...
- The meeting organizer should clarify the purpose of each meeting with a clear subject and agenda on the invite. If someone invites you to a meeting and the purpose is not clear, you should feel empowered to ask them to clarify ahead of time. 
...
- If a meeting is scheduled to make a specific decision, let's agree on who the ultimate decision-maker (for example: PM, Designer, Tech Lead, Engineering Manager) is first in case we don't get to consensus. That will help us avoid endless debates and make a decision promptly.
...
- As much as possible, we should avoid talking about the status of deliverables, as those are already communicated in standups and other forums.
- Some common topics:
...
- Positive and constructive feedback are equally important.
...
- I prefer to recognize people for specific good work that they did publicly. For example: with an email to the team, a shout out at an all-hands, or using our internal recognition tool. This makes your good work visible and encourages others to emulate the same behaviors. Let me know if you are not comfortable with public recognition, and I will do it privately. I will always provide constructive feedback in private only.
...
Good performance reviews require multiple steps. You write a self-reflection, peers provide feedback, managers calibrate, and managers write reviews and assign ratings. We will do that twice a year.
...
Every team is different so there is no magic bullet when it comes to process. We should reflect often on our process in team retrospectives and continuously make it even better. Having said that, there are some things that have worked well for me in the past. These are a good start.

- As a guiding principle, we should keep the process as light as possible to minimize unnecessary overhead and cognitive load. Think "Minimum Viable Process (MVP)."
...
- Make sure your goals are clear and aligned. The task you work on should be aligned with your team’s goals. And your team’s goals should be aligned with company goals. Let me know if you ever feel that this is not the case, as it may be my fault and something that I need to correct.
...
- Do the simple things very well. Many things in Software Development are complex. For example, [cache invalidation and naming things](https://martinfowler.com/bliki/TwoHardThings.html). But some things fall into the simple category. We should consistently get 100% on the simple things.
...
- I am an [External Thinker](https://coachapproachministries.org/thinking-styles/). To form an opinion on a topic, or come up with a solution to a problem, I often talk through it out loud to refine my thoughts. If it's not clear whether I'm still processing or if I'm done, please ask.
...
- Lack of ownership. There are always other people (customers, coworkers) who depend on our work. Not being proactive and trying hard to get work done makes me upset.
